          ...
          <Grid item xs={12} md={6}>
            <Fade in={true} timeout={600}>
              <Box sx={{ textAlign: { xs: 'center', md: 'left' }, mb: { xs: 4, md: 0 } }}>
                ...
                >
                  Sign in to your account and continue managing your expenses with ease.
                </Typography>
                
                {/* Feature highlights */}
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                  {[
                    { icon: '⚡', text: 'Lightning fast expense tracking' },
                    { icon: '📱', text: 'Mobile-friendly responsive design' },
                    { icon: '💡', text: 'Smart insights and analytics' },
                    { icon: '🔐', text: 'Bank-level security protection' }
                  ].map((feature, index) => (
                    <Box 
                      key={index}
                      sx={{ 
