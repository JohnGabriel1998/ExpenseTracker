...
const categoryColors: Record<ExpenseCategory, string> = {
  ...
  'Shopping': '#8b5cf6',
  'Travel': '#f97316',
  'Send Money to Philippines': '#ec4899',
  'Credit Card': '#84cc16',
  'Others': '#64748b',
};
                      ...
                      >
                        ...
                        <TableCell>
                          <Chip 
                            ...
                            size="small"
                            sx={{
                              background: `linear-gradient(135deg, ${categoryColors[expense.category]}20 0%, ${categoryColors[expense.category]}30 100%)`,
